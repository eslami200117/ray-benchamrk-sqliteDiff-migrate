-- Ensure we have our current_uuid table
...
CREATE TRIGGER tr_android_metadata_insert
BEFORE INSERT ON android_metadata
FOR EACH ROW
...
CREATE TRIGGER tr_point_ray_db_insert
BEFORE INSERT ON point_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_multipoint_ray_db_insert
BEFORE INSERT ON multipoint_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_multipoint_points_ray_db_insert
BEFORE INSERT ON multipoint_points_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_description_project_ray_db_insert
BEFORE INSERT ON description_project_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_custom_field_ray_db_insert
BEFORE INSERT ON custom_field_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_columns_template_ray_db_insert
BEFORE INSERT ON columns_template_ray_db
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_tblExceptionLog_insert
BEFORE INSERT ON tblExceptionLog
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_tblQuickCode_insert
BEFORE INSERT ON tblQuickCode
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_tblQuickCodeGroup_insert
BEFORE INSERT ON tblQuickCodeGroup
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
...
CREATE TRIGGER tr_tblCadastreLog_insert
BEFORE INSERT ON tblCadastreLog
FOR EACH ROW
WHEN NEW.uuid IS NULL
BEGIN
